...
class DEXConnector:
    ...
    async def connect(self):
        ...
        try:
            ...
            if test_response and 'data' in test_response:
                ...
                logger.info(f"Connection successful - {len(networks)} networks available")
        ...
        try:
            ...
            async with self.session.get(url, params=params) as response:
                ...
                if response.status == 200:
                    ...
                    logger.error(f"Request failed: {endpoint} - Status {response.status}")
                    return None
    ...
    def _check_rate_limit(self) -> bool:
        ...
        # Check per-minute limit (60 requests per minute for free tier)
        now = time.time()
        minute_ago = now - 60
        recent_requests = [t for t in self.rate_limiter['request_times'] if t > minute_ago]
    ...
    async def get_token_trades(self, token_address: str, chain: str = 'solana', limit: int = 100) -> List[Dict]:
        """
    ...
    async def get_token_liquidity(self, token_address: str, chain: str = 'solana') -> Dict:
        """
    ...
    async def get_token_price(self, token_address: str, chain: str = 'solana') -> Dict:
        ...
        try:
            ...
            if response and 'data' in response:
                ...
                logger.info(f"Retrieved price info for {token_address}: ${price_info.get('value', 'N/A')}")
                return price_info
            else:
    ...
    async def get_trending_tokens(self, chain: str = 'solana', limit: int = 50) -> List[Dict]:
        """
    ...
    def _calculate_liquidity_quality(self, liquidity_info: Dict) -> float:
        ...
        try:
            ...
            missing_fields = [field for field in required_fields if field not in liquidity_info]
    ...
    def get_stored_trades(self, token_address: str, chain: str = 'solana', limit: int = 100) -> List[Dict]:
    ...
    def get_rate_limit_status(self) -> Dict:
        ...
        return {
            ...
            'remaining': self.rate_limiter['daily_limit'] - self.rate_limiter['requests_made'],
